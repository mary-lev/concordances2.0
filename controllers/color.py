...
def index():
    ...
    if form2.process(formname='form_two').accepted:
        ...
        response.flash="form accepted"
    return dict(colours2=colours2, all_colours=all_colours, all_words=all_words, authors=authors, auts=auts, form=form, form2=form2, proc=proc, new_data=new_data, average_pro = average_pro, au_pro = au_pro)
