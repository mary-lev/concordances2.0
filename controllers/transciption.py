...
def index():
    ...
    dic = ''
    dictionary = []
#    f = open('/home/concordance/web2py/applications/test/rhymes/severyanin.txt', 'r')
#    content = f.readlines()
#    f.close()
    text = trymysql(trymysql.stih.author==21).select()
    content = [[all.rhymes, all.id] for all in text]
    for line in content:
        i = line[1]
        trtext = []
        ...
        for word in line.split():
            ...
            trtext.append(word.encode('utf-8'))
        n = trymysql(trymysql.stih.id==i).select()[0]
        n.update_record(trhymes=(' '.join(trtext)))
#        z = codecs.open('/home/concordance/web2py/applications/test/rhymes/t_sev.txt', 'a', 'utf-8')
#        z.write('['+text+']')
#        z.write(' '.join(trtext) + '\n')
#        z.close()
    return dict(tr=tr)
